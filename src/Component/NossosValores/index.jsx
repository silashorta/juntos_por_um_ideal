...
function NossosValores() {
    ...
    return (
        <section className='overflow-hidden flex flex-col px-4 py-8 lg:p-16 gap-8'>
            <motion.h2
            key={ref}
            animate={{ opacity: isInView ? 1 : 0, scale: isInView ? 1 : 0.95 }}
            transition={{ ease: "easeOut", duration: 0.5 }}
            className='font-bebas-neue text-4xl text-dark-blue'>Nossos Valores</motion.h2>
            <div className='flex flex-col gap-6 text-center'>
                <motion.h3
                animate={{ opacity: isInView ? 1 : 0 }}
                transition={{ ease: "easeOut", duration: 0.5 }}
                className='text-5xl text-gray-600'>O que valorizamos</motion.h3>
